    ...
    <section id="about" className="bg-white py-24 md:py-32">
      <Container>
        <Reveal>
          ...
          <h2 className="mt-3 text-balance font-display text-3xl font-semibold tracking-tight text-ink-900 md:text-4xl">
            {site.name}
          </h2>
        ...
        <div className="mt-14 grid grid-cols-1 gap-16 md:grid-cols-[1.3fr_1fr]">
          ...
          <Reveal delay={200} className="md:sticky md:top-24 md:self-start">
            <Terminal />
          </Reveal>
        </div>
      </Container>
